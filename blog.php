...
<header class="blog-header">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10 col-md-offset-1 pb-40">
                <dir class="row title">
                    <div class="col-md-7">
                        ...
                        <div id="mc_embed_signup">
                            <form
                                ...
                                <div class="input-container">
                                    ...
                                    <input class="btn btn-black btn-shadow submit" name="subscribe" type="submit"
                                        value="Go!">
                                </div>
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="banner-image latest-post">
				...
				?>
                <div class="row">
                    <div class="col-md-6 col-image visible-xs visible-sm"
                        style="background-image: url('<?php echo $recent_img_url; ?>')"></div>
                    <div class="col-md-6 col-sm-12 col-xs-12 text-col">
                        <div>
                            <p class="x-small category"><?php echo get_the_category_list( ', ', '', $recent["ID"]); ?>
                            </p>
                            <h3><?php echo $recent["post_title"];  ?></h3>
                            <span
                                class="tag-list"><?php echo get_the_tag_list( '#', ' #', '', $recent["ID"] ); ?></span>
                        ...
                        <div class="post-meta grey">
                            <ul>
                                    ...
                                    <p class="x-small">
                                        <span class="posted-on">
                                            <time class="entry-date published"
                                                datetime="2018-11-27T11:42:52+00:00"><?php echo transformationspace_posted_on(); ?></time>
                                        </span>
                                    </p>
                                </li>
                                <li class="likes">
                                ...
                                <li class="read-time">
                                    <p class="x-small"><?php echo estimate_time_read($recent["post_content"]); ?> read
                                    </p>
                                </li>
                            </ul>
                        </div>
                        <div class="button-container">
                            <a class="btn btn-yellow shadow" tabindex="0"
                                href="<?php echo get_permalink($recent["ID"])?>">
                                <strong>read more</strong>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-6 col-image hidden-xs hidden-sm"
                        style="background-image: url('<?php echo $recent_img_url; ?>')"></div>
                </div>
                <?php } 
					wp_reset_query();
                ...
                <div class="col-md-6">
                    ...
                    <div class="blog-small-feature">
                        ...
                        <div class="text-block">
                            <div class="category blue"><?php echo get_the_category_list( ', ', '', $featured["ID"]); ?>
                            </div>
                            <h3><?php echo $featured["post_title"];  ?></h3>
                            <p><?php echo create_excerpt($featured["post_content"], 120);  ?></p>
                        </div>
                        <div class="button-container"><a class="btn btn-black read-more shadow" tabindex="0"
                                href="<?php echo esc_url( get_permalink($featured['ID'])); ?>">read more</a></div>
                    </div>
                    <?php } ?>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="blog-item-small">
                        <div class="category blue">
                            <?php echo get_the_category_list( ', ', '', $recent_highlight["ID"]); ?></div>
                        <h2><?php echo $recent_highlight["post_title"];  ?></h2>
                        <span
                            class="tag-list"><?php echo get_the_tag_list( '#', ' #', '', $recent_highlight["ID"] ); ?></span>
                        <div class="author-col">
                            ...
                            <a href="<?php echo get_permalink($recent_highlight["ID"])?>" class="read-more plus-btn"
                                tabindex="0">
                                <span class="btn-plus">
