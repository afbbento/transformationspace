<?php
/**
* Template part for Persons Home
*
...
<div class="row person big <?php echo $image_position; ?>" >
    <div class="col-md-12">
        ...
        <div class="text-container">
            ...
            <button data-fancybox data-src="#talkMoreModal" id="facilitator-<?php echo $i; ?>" class="btn btn-transparent btn-icon facilitator-js" data-name="<?php the_sub_field('name'); ?>">
                <svg class="talk-icon" width="24" height="19" viewBox="0 0 24 19" fill="black"
