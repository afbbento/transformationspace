					 	   			...
					 	   			<div class="row">					 	   								 	   						
						                  ...
						                  <div class="image-label">Team<?php echo get_sub_field('video_caption'); ?></div>	
					 	   				...
					 	   				<div class="col-md-4">
					 	   					...
					 	   					<div class="btn-container text-center"><a href="stories" class="btn btn-yellow btn-shadow">discover more</a></div>
					 	   				</div>
					 	   			</div>
	 	   		...
	 	   		<div class="stories-slider-container">
		         	...
		         	?>
					    ...
					    <div class="row">
					        ...
					        <div class="col-md-6 col-sm-6 col-sx-6 image-container hidden-xs" style="background-image: url('<?php the_field('video_cover'); ?>');">
					        	<div class="play-button-outer small">
								  <a data-fancybox data-width="640" data-height="360" href="https://vimeo.com/<?php the_field('vimeo_video_id'); ?>">
								  	<div class="play-button"></div>
								  </a>
