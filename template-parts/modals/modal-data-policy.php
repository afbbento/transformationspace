<div style="display: none;" id="policyModal" class="animated-modal text-center p-5 theme--dark">
	...
	<div class="btx-text-content-inner">
		...
		<p>Transformation Space ("us", "we", or "our") operates the https://thetransformation.space/ website (the "Service").</p>
		...
		<p>We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of
			...
			https://thetransformation.space/</p>
		...
		<h2 class="title">Use of Data</h2>

		<p>Transformation Space uses the collected data for various purposes:</p>
		<ul>
		...
		<h2 class="title">Transfer Of Data</h2>
		...
		<p>If you are located outside Portugal and choose to provide information to us, please note that we transfer the
			data, including Personal Data, to Portugal and process it there.</p>
		<p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to
			that transfer.</p>
		<p>Transformation Space will take all steps reasonably necessary to ensure that your data is treated securely and in
		...
		<h2 class="title">Disclosure Of Data</h2>

		<h3>Legal Requirements</h3>
		<p>Transformation Space may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
		<ul>
			<li>To comply with a legal obligation</li>
			<li>To protect and defend the rights or property of Transformation Space</li>
			<li>To prevent or investigate possible wrongdoing in connection with the Service</li>
			<li>To protect the personal safety of users of the Service or the public</li>
			<li>To protect against legal liability</li>
		</ul>

		<h2 class="title">Security Of Data</h2>
		...
		<ul>
			<li>By email: <a href="mailto:info@thetransformation.space">info@thetransformation.space</a></li>
		</ul>
	</div>
</div>