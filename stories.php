                    ...
                    <div class="col-md-5 col-sm-12 newsletter">
                        ...
                        <div id="mc_embed_signup">
                            <form
                                ...
                                class="form-inline newsletter-sidebar form-newsletter-js" target="_blank">
                ...
                <div class="bootcamp-stories-ajax" style="display:none;">
					...
					?>
                                    ...
                                    <div class="col-md-8 featured">
                                        <div class="video-container">
                                            <div class="play-button-outer big">
                                                <a data-fancybox="" data-width="640" data-height="360"
                                                    href="https://vimeo.com/<?php echo $video_ID; ?>">
                                        ...
                                        <div class="post-meta">
                                            <p class="x-small"><span
                                                    class="time"><?php echo vimeoVideoDuration($video_ID); ?></span>
                                            </p>
                                        </div>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <div class="col-md-4 col-sm-12 story-item story-item-right">
                                        ...
                                        <div class="text">
                                            <p class="x-small title"><span><?php echo $post_title; ?></span><span
                                                    class="time"><?php echo vimeoVideoDuration($video_ID); ?></span></p>
                                            <p class="x-small"><?php echo $text; ?></p>
                                            <div class="post-meta">
                                                <p class="x-small">
                                                    <?php echo transformation_time_link($story->ID, $post_date); ?>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
